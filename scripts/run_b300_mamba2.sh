...
# The 24-layer 130M payload registers 64.824 GiB of plaintexts. B300 has
# enough HBM to retain them all; DGX Spark keeps the shared 5 GiB default.
PT_CACHE_GIB="${PT_CACHE_GIB:-65}"
